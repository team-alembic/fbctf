...
function install_unison() {
  cd /
  dl_pipe "https://www.archlinux.org/packages/extra/x86_64/unison/download/" | sudo tar -I zstd -xvf 
}
...
function install_nodejs() {
  log "Downloading and setting node.js version 9.x repo information"
  dl_pipe "https://deb.nodesource.com/setup_9.x" | sudo -E bash -
